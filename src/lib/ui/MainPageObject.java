...
public class MainPageObject {
    ...
    public WebElement waitForElementAndSendKeys(By by, String value, String error_message, long timeoutSeconds) {
        MobileElement element = (MobileElement)waitForElementPresent(by,error_message,timeoutSeconds);
    ...
    public void assertElementPresent(By by, String error_message) {
        int amount_of_elements = getAmountOfElements(by);
        if (amount_of_elements == 0) {
            String default_message = "An element '" + by.toString() + "' supposed be not present";
            throw new AssertionError(default_message + " " + error_message);
        }
    }
    ...
    public WebElement parent(WebElement child) {
